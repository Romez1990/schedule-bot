...
def callback_handler(payload_class: Type[Payload]) -> type:
    class CallbackHandler:
        def __init__(self, method: Callable[[MessengerController, Callback], Awaitable[None]]) -> None:
        ...
        async def __call__(self, messenger_controller: MessengerController, callback: Callback) -> None:
            await self.__method(messenger_controller, callback)
